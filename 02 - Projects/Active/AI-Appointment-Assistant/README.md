...
- [[Vision]] — plain-language product vision
- [[Claude-Brain-Prompt]] — the scheduling brain prompt
- [[QA-Review-v1]] — first-pass QA review
- [[Lessons-Learned]] — what this project has taught us
- [[Scheduling-Rules]] — rules that govern booking decisions
- [[Supabase-Connection]] — database + RLS setup specifics
